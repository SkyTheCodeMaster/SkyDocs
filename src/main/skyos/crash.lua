...
-- @tparam string stacktrace Stacktrace to save, generated by `debug.traceback(coro).
-- @tparam string error Primary error of this crash report.
-- @tparam[opt] string msg A message to put at the top of the crash report, or nothing if unpassed.
local function crashreport(stacktrace,err,msg)
  local diagstr = systemInformation()
  local crashstr = msg and string.format("---MESSAGE---\n%s\n---DIAGNOSTIC INFORMATION---\n%s\n---ERROR---\n%s\n---STACKTRACE---\n%s",msg,diagstr,err,stacktrace) or string.format("---DIAGNOSTIC INFORMATION---\n%s\n---ERROR---\n%s\n---STACKTRACE---\n%s",diagstr,err,stacktrace)
