...
edit(V,B,G,K,Q,J,X)e(1,V,"string")e(2,B,"number","nil")e(3,G,"number","nil")e(4,K,"number","nil")e(5,Q,"number","nil")e(6,J
"function","nil")e(7,X,"table","nil")if not o[V]then
error("Button "..V.." does not exist.",2)end B=B or o[V].x G=G or o[V].y K=K or
o[V].w Q=Q or o[V].h local Z=J or o[V].fFunc local et=X or o[V].tDraw local
tt=o[V].enabled o[V]={x=B,y=G,w=K,h=Q,fFunc=Z,tDraw=et,enabled=tt,}end function
